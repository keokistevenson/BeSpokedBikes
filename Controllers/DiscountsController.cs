...
namespace BeSpokedBikes.Controllers
{
    public class DiscountsController : Controller
    {
        ...
        {
            var beSpokedContext = _context.Discounts.Include(d => d.Product);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProductId,BeginDate,EndDate,DiscountPercentage")] Discount discount)
        {
            if (id != discount.Id)
            {
                return NotFound();
